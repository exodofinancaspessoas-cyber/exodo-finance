...
export default function OnboardingFlow({ onStageChange, onComplete }: OnboardingFlowProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-slide-up w-full max-w-[280px] pointer-events-auto md:right-32">
      <div className="bg-white border border-slate-200 shadow-2xl rounded-2xl overflow-hidden ring-4 ring-orange-500/5">
        ...
        <div className="bg-slate-50/50 px-5 py-3 border-b border-slate-100">
          <div className="flex items-center justify-between mb-1">
            ...
            {currentStep > 0 && (
              <span className={`text-[9px] font-bold px-1.5 py-0.5 rounded bg-orange-100 text-orange-700 uppercase`}>
                Configuração
              </span>
            )}
          </div>
              ...
              return (
                <div key={step} className="relative z-10 flex flex-col items-center">
                  <button
                    ...
                    ${isCurrent ? 'bg-orange-500 text-white ring-4 ring-orange-500/10 scale-105' :
                        isDone ? 'bg-emerald-500 text-white' : 'bg-white border text-slate-300'}
                  `}>
